import {
    ...
    findAllPopular as findAllPopularService,
} from "../../service/frontend/ProductsService.js"
...
export const findAllPopular = async (req,res,next) => {
    try {
        const response = await findAllPopularService(req)
        CreateResponse(res, response)
    } catch (error) {
        next(error)
    }
