import {
    ...
    isActive as isActiveService,
    nonActive as nonActiveService
} from "../../service/backend/UsersService.js"
...
export const isActive = async (req,res,next) => {
    try {
        const response = await isActiveService(req)
        CreateResponse(res, response)
    } catch (error) {
        next(error)
    }
...
export const nonActive = async (req,res,next) => {
    try {
        const response = await nonActiveService(req)
        CreateResponse(res, response)
    } catch (error) {
        next(error)
    }
