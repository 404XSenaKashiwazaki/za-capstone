...
import { useFindOneProductsPackagedQuery } from '../../features/api/apiPackaged'
import { useFindOneProductsShippingQuery } from '../../features/api/apiShipping'

const Detail = ({ id, setId, showModal, setShowModal, username  }) => {
  const [ data, setData ] = useState(null)
  const { data: dataPayment  } = useFindOneProductsShippingQuery({ produkid: id, username }, { skip: (id) ? false : true })
