...
const Form = ({ id, setId, showModal, setShowModal,dataUser }) => {
    ...
    const { data: dataPayment  } = useFindOneProductsNotYetPaidQuery({ produkid: id, username: dataUser?.username }, { skip: (id) ? false : true })
