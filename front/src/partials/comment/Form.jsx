...
import { useFindOneComment_Query, useUpdateComment_Mutation } from '../../features/api/apiCommentSlice'
import { useDispatch, useSelector } from 'react-redux'
import { setMessage } from '../../features/commentSlice'
...
const Add = () => {
  ...
  const { data, isSuccess, isError, error, isLoading} = useFindOneComment_Query({ contactid : modalDataId  },{ skip: (modalDataId) ? false: true })
  const [ update, { isSuccess: isSuccessUpdate, isError: isErrorUpdate, error: errorUpdate, isLoading: isLoadingUpdate } ] = useUpdateComment_Mutation()
