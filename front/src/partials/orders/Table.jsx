...
import { faCommentAlt, faEdit,faPlus,faSearch, faSyncAlt, faTrashAlt } from '@fortawesome/free-solid-svg-icons'
                  ...
                  return (
                    <tr key={d.id}>
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="font-medium text-slate-800">{ d.User.namaDepan+" "+d.User.namaBelakang }</div>
                        </div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                          <div className="text-start font-medium"> { (d.Products && d.Products.length > 0) && d.Products.map(e2=> <p key={e2.id} className="font-medium">{ e2.nama_produk }</p>) }</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                          <div className="text-start font-medium"> <span className={`w-full px-4 ${ typeBtn(d.status) } text-white py-1 w-full overflow-hidden text-ellipsis whitespace-nowrap rounded-none font-bold text-sm uppercase transition`}>{ d.status }</span></div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-lg text-center p-1 flex gap-1">
                            <button 
                              onClick={(e) => {
                                setItemContact({
                              ...
                              className='w-auto 
                                ...
                                text-white font-medium py-1 px-4 text-sm
                                rounded-sm hover:bg-gradient-to-l 
                            ...
                            <button 
                              onClick={(e) => handleDestroy(e, d.User.namaDepan+" "+d.User.namaBelakang,d.id)}
                              className='
