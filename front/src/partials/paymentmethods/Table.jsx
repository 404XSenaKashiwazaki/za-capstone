                        ...
                        <td className="p-2 whitespace-nowrap ">
                            <div className="flex items-center">
                                <div className="shrink-0 mr-2 mt-2 sm:mr-3">
                                    <img className="rounded-sm w-16 h-16" src={d.logoUrl} alt={d.name} />
                                </div>
                                <div className="font-medium text-slate-800">{d.name}</div>
                            </div>
                        </td>
                        <td className="p-2 whitespace-nowrap">
                            <div className="text-left font-medium text-sm w-full overflow-hidden text-ellipsis whitespace-nowrap  text-gray-900">{ d.desk }</div>
                        </td>
                        <td className="p-2 whitespace-nowrap">
