...
import { useFindOneProductsCancelledQuery } from '../../features/api/apiCancelledSlice'

const Detail = ({ id, setId, showModal, setShowModal, username  }) => {
  const [ data, setData ] = useState(null)
  const { data: dataPayment  } = useFindOneProductsCancelledQuery({ produkid: id, username }, { skip: (id) ? false : true })
