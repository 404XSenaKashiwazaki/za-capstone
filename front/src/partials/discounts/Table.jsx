...
import { faEdit,faTrashAlt,faSyncAlt } from '@fortawesome/free-solid-svg-icons'
          ...
          <table className="table-auto w-full">
              ...
              <thead className="text-xs font-semibold uppercase text-slate-400 bg-slate-50">
                ...
                <th className="p-2 whitespace-nowrap ">
                  ...
                  <th className="p-2 whitespace-nowrap">
                    <div className="font-semibold text-left">Diskon</div>
                  </th>
                  <th className="p-2 whitespace-nowrap">
                    ...
                    <tr key={d.id}>
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="font-medium text-slate-800">{d.diskon} %</div>
                        </div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium ">{ d.deskripsi }</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
