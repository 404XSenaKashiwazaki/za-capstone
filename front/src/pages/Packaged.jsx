...
import { faBoxesPacking, faExclamationTriangle } from '@fortawesome/free-solid-svg-icons'
...
const Packaged = ({ site }) => {
  ...
  const selectPerpage = [
    ...
    const { data: dataNotPaid, isError, isLoading, error, refetch } = useFindAllProductsPackagedQuery({ username: dataUser?.username, restores: isRestore, search, page, perPage },{ refetchOnMountOrArgChange: (navigate || isRestore),skip: (dataUser) ? false: true })
