...
import { faCancel, faExclamationTriangle, faTruck } from '@fortawesome/free-solid-svg-icons'
...
const Packaged = ({ site }) => {
  ...
  const selectPerpage = [
    ...
    const { data: dataNotPaid, isError, isLoading, error, refetch } = useFindAllProductsCancelledQuery({ username: dataUser?.username, restores: isRestore, search, page, perPage },{ refetchOnMountOrArgChange: (navigate || isRestore),skip: (dataUser) ? false: true })
