...
const FooterHome = ({ site }) => {
   ...
   return (
   <div className="mx-5">
        <div className="mx-5 h-auto box-border mt-10">
        ...
        <footer className="footer px-4 py-4 border-t-slate-50  text-base-content border-base-300 mt-0">
            <aside className="items-center grid-flow-col text-slate-900">
            ...
            <p>{ sites?.site?.title }. <br/> { new Date().getFullYear() }</p>
            </aside> 
